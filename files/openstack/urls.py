...
ngdetails_url = url(r'^openstack/ngdetails/',
...
for u in getattr(settings, 'AUTHENTICATION_URLS', ['openstack_auth.urls']):
    urlpatterns.append(url(r'^openstack/auth/', include(u)))
...
if settings.DEBUG:
    urlpatterns.append(url(r'^openstack/500/$', defaults.server_error))
